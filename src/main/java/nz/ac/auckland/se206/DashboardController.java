...
public class DashboardController {
	...
	@FXML
	private MenuButton accuracySettingButton;

	@FXML
	private MenuButton wordsSettingButton;

	@FXML
	private MenuButton timeSettingButton;

	@FXML
	private MenuButton confidenceSettingButton;

	@FXML
	private Button startNormalGame;

	@FXML
	private Button startZenGame;

	@FXML
	private Button startHiddenGame;
	 ...
	 */
	@FXML
	private void onSwitchToProfile(ActionEvent event) throws IOException, TranslateException, URISyntaxException {
	 ...
	 */
	@FXML
	private void onSwitchToLeaderboard(ActionEvent event) throws IOException, TranslateException, URISyntaxException {
		MenuController.buttonSound();
		// Update welcome label in profile
	...
	protected void updateWelcomeLabel() {
		...
		accuracySettingButton.setText("Accuracy: " + currentUser.getDifficultyString(currentUser.getAccuracySetting()));
		wordsSettingButton.setText("Words: " + currentUser.getDifficultyString(currentUser.getWordsSetting()));
		timeSettingButton.setText("Time: " + currentUser.getDifficultyString(currentUser.getTimeSetting()));
		confidenceSettingButton
				.setText("Confidence: " + currentUser.getDifficultyString(currentUser.getConfidenceSetting()));
	 ...
	 * @param levelSetting       the level of difficulty the user would like to
	 *                           choose
	 */
